...
*/
    ...
    this.container1 = this.add
      .container(200, 600, [this.btn1, this.text1])
      .setAlpha(0);
    ...
    this.container2 = this.add
      .container(1050, 600, [this.btn2, this.text2])
      .setAlpha(0);
    ...
    this.container3 = this.add
      .container(620, 600, [this.btn3, this.text3, face])
      .setAlpha(0);
